...
Ausführung: Aus Dedekind-Repo-Root oder aus DedekindStudio:
  python DedekindStudio/scripts/test_kernel_manual.py
  oder (von DedekindStudio aus): python scripts/test_kernel_manual.py
...
# Repo-Root: von DedekindStudio/scripts/ zwei Ebenen hoch = DedekindStudio, drei = Repo
