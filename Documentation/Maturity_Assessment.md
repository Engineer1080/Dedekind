...
**Dedekind Language**  
Draft: January 2026 · Stand: v1.4.0 (Prototyp)

---

## Übersicht

Dedekind ist aktuell ein **Prototyp (v1.4.0)**. Die folgende Einschätzung bezieht sich auf den **aktuellen Implementierungsstand** und nennt Lücken sowie Roadmap-Punkte.
