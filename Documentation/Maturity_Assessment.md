...
Dedekind ist aktuell ein **Prototyp (v1.0.2)**. Die folgende Einschätzung bezieht sich auf den **aktuellen Implementierungsstand** und nennt Lücken sowie Roadmap-Punkte.
