...
**Stand:** Basierend auf Code und Changelogs (v1.14.0, Dezember 2026). Dedekind ist ein **Prototyp** – die Sprache wird nach Python transpiliert und nutzt PyTorch/NumPy als Laufzeit.
