...
**Stand:** Basierend auf Code und Changelogs (v1.11.0, September 2026). Dedekind ist ein **Prototyp** – die Sprache wird nach Python transpiliert und nutzt PyTorch/NumPy als Laufzeit.
