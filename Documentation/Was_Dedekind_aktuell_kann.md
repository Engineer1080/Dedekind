...
**Stand:** Basierend auf Code und Changelogs (v1.2.9, Februar 2026). Dedekind ist ein **Prototyp** – die Sprache wird nach Python transpiliert und nutzt PyTorch/NumPy als Laufzeit.
