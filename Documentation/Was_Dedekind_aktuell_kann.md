...
**Stand:** Basierend auf Code und Changelogs (v1.19.0, Mai 2027). Dedekind ist ein **Prototyp** – die Sprache wird nach Python transpiliert und nutzt PyTorch/NumPy als Laufzeit.
