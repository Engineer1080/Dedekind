...
**Stand:** Basierend auf Code und Changelogs (v1.15.0, Januar 2027). Dedekind ist ein **Prototyp** – die Sprache wird nach Python transpiliert und nutzt PyTorch/NumPy als Laufzeit.
