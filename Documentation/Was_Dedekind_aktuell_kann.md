...
- **Strömungsmechanik (`use fluid_dynamics`):** Vollumfängliche, differenzierbare CFD-Pipeline.
  ...
  - **Thermal LBM mit Boussinesq-Buoyancy:** Double-Distribution Solver (`lbm_thermal_simulation`, `lbm_thermal_with_obstacle`) — D2Q9 für Strömung, D2Q5 für Temperatur, gekoppelt über Boussinesq-Auftrieb. Beheizte Dirichlet-Hindernisse, Rayleigh-/Nusselt-Zahl-Diagnostik. Anwendungen: Rayleigh-Bénard-Konvektion, Wärmetauscher-Design, Klimaforschung, Reaktorkühlung.
