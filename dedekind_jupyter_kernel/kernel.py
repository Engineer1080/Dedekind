...
# Ensure Dedekind compiler is importable (repo root or installed)
...
class DedekindKernel(Kernel):
    ...
    implementation_version = "0.9.9"
    language = "dedekind"
    language_version = "0.9.9"
    language_info = {
        "name": "dedekind",
        "mimetype": "text/x-dedekind",
        "file_extension": ".ddk",
    }
    banner = "Dedekind Kernel – compile and run Dedekind code (Dedekind Language v0.9.9)"
